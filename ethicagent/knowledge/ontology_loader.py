...
class OntologyNode:
    ...
    def __init__(self, name: str, parent: OntologyNode | None = None, **attrs: Any):
        self.name = name
        self.parent = parent
    ...
    def is_descendant_of(self, ancestor_name: str) -> bool:
        ...
        node: OntologyNode | None = self.parent
        while node:
